    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Guardar mi nombre y email en este buscador para la próxima vez que haga un comentario.</label>
        </div>
      </div>
      {error && <p className="text-xs text-red-500">Debes rellenar todos los campos correctamente</p>}
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-green-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Enviar Comentario</button>
